...
export const projects: Project[] = [
  {
    ...
    background:
      "기업 내 반복되는 인사 행정 업무의 비효율을 해결하기 위해 SaaS 형태의 통합 HR 솔루션이 필요했습니다. 서비스 기획에 앞서 시프티·플렉스·원티드스페이스·에버타임·워크업·유스트라HR 6개 경쟁사를 분석하여 출퇴근 관리·휴가·전자결재·급여 정산 등 HR 솔루션이 갖춰야 할 핵심 기능을 도출했습니다.",
    myRole: [
  ...
  },
  {
    ...
    duration: "2024 – 2025",
    tags: ["BASE44", "글로벌", "IA 설계", "다국어", "블록체인"],
    background:
      "전 세계 의료관광 시장은 연평균 15.7% 성장하며 2027년까지 약 2,730억 달러 규모로 확대될 전망입니다. 한국의 세계적 수준 의료기술과 글로벌 소비자를 연결하는 토큰 기반 의료관광·헬스커머스 플랫폼이 필요했습니다. 두바이 현지 클라이언트를 대상으로 프로토타입 시연을 통해 빠른 피드백 수렴이 핵심 과제였습니다.",
    myRole: [
      ...
      "BASE44 바이브코딩으로 실제 작동하는 예약 화면 프로토타입 직접 구현",
  ...
  },
  {
    ...
    role: "서비스 기획 / UX 설계",
    duration: "2022 – 2023",
    tags: ["Figma", "블록체인", "QA", "Google Play"],
    background:
      "기술적 진입장벽이 높은 블록체인 지갑을 일반 사용자도 금융 앱처럼 직관적으로 사용할 수 있도록 UI/UX를 개선하고 실제 마켓에 출시하여 검증해야 했습니다. Google Play Console의 엄격한 금융·보안 정책 심사 통과가 핵심 도전 과제였습니다.",
    myRole: [
      "서비스 기획 및 UX 설계 전담",
  ...
  },
  {
    ...
    role: "서비스 기획",
    duration: "2023 – 2024",
    tags: ["Watch-to-Earn", "글로벌", "BM 설계", "Google Play"],
    background:
      "미국 대학 이스포츠 리그를 실시간 스트리밍하고, 광고 시청 시 포인트를 지급하여 인앱 스토어에서 상품을 구매할 수 있는 Watch-to-Earn 수익 모델의 글로벌 미디어 플랫폼을 기획했습니다. 콘텐츠 소비와 광고 수익이 연결되는 지속 가능한 비즈니스 모델 구현이 핵심이었습니다.",
    myRole: [
      "서비스 기획 전담",
