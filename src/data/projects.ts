...
export const projects: Project[] = [
  {
    ...
    process: [
      ...
      { url: "/projects/hr/figma3.png", label: "Figma — 휴가 신청 플로우" },
      { url: "/projects/hr/figma4.png", label: "Figma — 증명서 발급" },
    ],
    outcomes: [
  ...
  },
  {
    ...
    process: [
      ...
      { step: "프로토타입", description: "바이브코딩 제작" },
      { step: "현지 시연", description: "두바이 클라이언트 피드백" },
    ],
    gallery: [
      { url: "/projects/kbio/plan_2.png", label: "프로젝트 개요 — 3대 핵심 가치" },
      { url: "/projects/kbio/plan_3.png", label: "시장 배경 — 글로벌 의료관광 성장" },
      { url: "/projects/kbio/plan_4.png", label: "서비스 비전 & 구조" },
      { url: "/projects/kbio/kbio1.png", label: "플랫폼 소개 — 4축 구조" },
      { url: "/projects/kbio/kbio2.png", label: "전체 앱 IA — 6개 메인 섹션" },
      { url: "/projects/kbio/kbio3.png", label: "서비스 구조 마인드맵" },
      { url: "/projects/kbio/kbio4.png", label: "사용자 예약 플로우 차트" },
      { url: "/projects/kbio/spec_1.png", label: "기능 정의서 — 전체 기능 명세" },
      { url: "/projects/kbio/KBIOAPP1.png", label: "프로토타입 예약화면" },
      { url: "/projects/kbio/KBIOAPP2.png", label: "프로토타입 두바이" },
    ],
    outcomes: [
  ...
  },
  {
    ...
    process: [
      ...
      { step: "화면 설계", description: "PPT 기능 명세" },
      { step: "정책 대응", description: "Google Play 심사" },
      { step: "QA", description: "예외 케이스 검증" },
      { step: "스토어 출시", description: "정식 배포" },
    ],
    gallery: [
      { url: "/projects/wallet/WALLET4.png.png", label: "기능명세서" },
      { url: "/projects/wallet/PAY1.png", label: "PAY 플로우차트1" },
      { url: "/projects/wallet/PAY2.png", label: "PAY 플로우차트2" },
      { url: "/projects/wallet/WALLET1.png", label: "화면기획서_레이아웃" },
      { url: "/projects/wallet/WALLET3.png", label: "화면기획서_송금" },
      { url: "/projects/wallet/WALLET2.png", label: "정책기획서" },
      { url: "/projects/wallet/WALLETQA.png", label: "QA 테스트시나리오" },
    ],
    outcomes: [
  ...
  },
  {
    ...
    gallery: [
      ...
      { url: "/projects/estv/estv.png", label: "플랫폼 기능정의서" },
      { url: "/projects/estv/ESTV1.png", label: "인앱 스토어 메인 화면" },
      { url: "/projects/estv/ESTV2.png", label: "인앱 스토어 VOD 화면" },
      { url: "/projects/estv/ESTV3.png", label: "메뉴 화면" },
    ],
    outcomes: [
